...
namespace LinkeD365.OrgSettings
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Org Settings"),
        ExportMetadata("Description", "Tool to update/view Org Settings on your instance"),
    ...
    public class OrgSettingsPlugin : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new OrgSettingsControl();
        }

        ///// <summary>
        ///// Constructor
        ///// </summary>
        //public OrgSettingsPlugin()
        //{
